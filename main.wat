(module
  ...
  (import "x" "y"(func $log (param i32)))

  ;; Define a single page memory of 64KB.
  (memory $0 1)

  ;;Emtpy function for exporting under a UTF-8 Name for padding
  ;;(func $a
  ;;  (i32.const 0)
  ;;  return
  ;;)
  ;;Use function export name to pad GBA game to offset(h) B0
  (export "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" (func $r))
  ...
  ;;Self run javascript
  ;;(data (i32.const 0) "<script>WebAssembly.instantiate(await fetch(location).then(n=>n.arrayBuffer()),{x:{y:function(n){console.log(n)}}})();</script>")
